package org.jeecg.modules.elfinder.servlet;
...
import org.jeecg.modules.elfinder.controller.executors.MissingCommandExecutor;
import org.jeecg.modules.elfinder.controller.ConnectorController;
import org.jeecg.modules.elfinder.controller.executor.CommandExecutorFactory;
import org.jeecg.modules.elfinder.controller.executor.DefaultCommandExecutorFactory;
import org.jeecg.modules.elfinder.impl.DefaultFsService;
import org.jeecg.modules.elfinder.impl.DefaultFsServiceConfig;
import org.jeecg.modules.elfinder.impl.FsSecurityCheckForAll;
import org.jeecg.modules.elfinder.impl.StaticFsServiceFactory;
import org.jeecg.modules.elfinder.localfs.LocalFsVolume;
...
public class ConnectorServlet extends HttpServlet
{
			...
			ServletConfig config)
	{
		...
		defaultCommandExecutorFactory.setClassNamePattern("org.jeecg.modules.elfinder.controller.executors.%sCommandExecutor");
	...
	protected DefaultFsService createFsService()
	{
		...
		fsService.addVolume("A", createLocalFsVolume("My Files", new File("/StagoCloud/a")));
		fsService.addVolume("B", createLocalFsVolume("Shared",   new File("/StagoCloud/b")));
