package org.jeecg.modules.elfinder.controller;
import org.jeecg.modules.elfinder.controller.executor.CommandExecutionContext;
...
public class ConnectorController {
   ...
   // @Resource(name = "fsServiceFactory")
    ...
    public void connector(HttpServletRequest request,
        ...
        System.out.println("ConnectorController cmd:"+cmd);
