...
(this, function () {
    ...
    ([function (e, t, o) {
                !function () {
                    ...
                    var t = o(1),
                    a = {};
                    a.title = "SpreadJS Designer",
                    a.defaultFont = "11pt Calibri",
                    a.ok = "OK",
                    a.yes = "Yes",
                    a.no = "No",
                    a.apply = "Apply",
                    a.cancel = "Cancel",
                    a.close = "Close",
                    a.fileAPINotSupported = "Browsers don't support File API",
                    a.blobNotSupported = "Browsers don't support Blob object",
                    a.saveFileDialogTitle = "Save As",
                    a.openFileDialogTitle = "Open",
                    a.allSpreadFileFilter = "All Spreadsheet files (*.ssjson *.xlsx)",
                    a.spreadFileFilter = "SpreadJS files (*.ssjson)",
                    a.ssJSONToJSFilter = "Javascript files (*.js)",
                    a.allExcelFilter = "All Excel files (*.xlsx)",
                    a.excelFileFilter = "Excel Workbook (*.xlsx)",
                    a.csvFileFilter = "CSV Files (*.csv)",
                    a.pdfFileFilter = "PDF Files (*.pdf)",
                    a.allFileFilter = "All Files (*.*)",
                    a.importFileDialogTitle = "Import",
                    a.exportFileDialogTitle = "Export",
                    a.insertCellInSheet = "Cannot shift cells off of whole sheet",
                    a.insertCellInMixtureRange = "This command cannot be used with selections that contain entire rows, or columns,and also other cells. Try select only entire rows, entire columns, or just groups of cells.",
                    a.NotExecInMultiRanges = "The command you chose cannot be performed with multiple selections. Select a single range and click the command again",
                    a.unsavedWarning = "The file has not been saved. Save it? ",
                    a.errorGroup = "Sheet has outline-column , Whether to continue operation ?",
                    a.requestTemplateFail = "Template file request error.",
                    a.requestTemplateConfigFail = "Template config file request error.",
                    a.openFileFormatError = "File format is not correct.",
                    a.closingNotification = "Warning: Current file has been modified.\nDo you want to save your changes?",
                    a.sameSlicerName = "Slicer name already in use. Please enter a unique name.",
                    a.nullSlicerName = "Slicer name is not valid.",
                    a.changePartOfArrayWarning = "Can not change part of an array.",
                    a.changePartOfTableWarning = "This won't work because it would move cells in a table on your worksheet.",
                    a.exportCsvSheetIndexError = "Sheet is not found.",
                    a.fontPicker = {
                    ...
                    a.customFormat = "Custom",
                    a.generalFormat = "General",
                    a.colorPicker = {
                    ...
                    a.dropdownDialog = {
                        ...
                        slider: {
                            ...
                            marks: "Marks",
                            formatter: "Format",
                            formatters: ["0", "0.00", "#,##0", "#,##0.00", "#,##0;(#,##0)", "#,##0.00;(#,##0.00)", "$#,##0;($#,##0)", "$#,##0.00;($#,##0.00)", "0%", "0.00%", "0.00E+00", "##0.0E+0", ' $* #,##0.00 ; $* #,##0.00 ; $* "-" ; @ ', '_-[$\xa5-804]* #,##0.00_-;-[$\xa5-804]* #,##0.00_-;_-[$\xa5-804]* "-"_-;_-@_-', '_-[$\xa5-411]* #,##0.00_-;-[$\xa5-411]* #,##0.00_-;_-[$\xa5-411]* "-"_-;_-@_-', '_-[$\u20a9-412]* #,##0.00_-;-[$\u20a9-412]* #,##0.00_-;_-[$\u20a9-412]* "-"_-;_-@_-']
                        },
                        workflowlist: {
                            title: "Workflow List",
                    ...
                    a.fractionFormats = ["# ?/?", "# ??/??", "# ???/???", "# ?/2", "# ?/4", "# ?/8", "# ??/16", "# ?/10", "# ??/100"],
                    a.numberFormats = ["0", "0;[Red]0", "0_);(0)", "0_);[Red](0)", "#,##0", "#,##0;[Red]#,##0", "#,##0_);(#,##0)", "#,##0_);[Red](#,##0)"],
                    a.dateFormats = ["m/d/yyyy", "[$-409]dddd, mmmm dd, yyyy", "m/d;@", "m/d/yy;@", "mm/dd/yy;@", "[$-409]d-mmm;@", "[$-409]d-mmm-yy;@", "[$-409]dd-mmm-yy;@", "[$-409]mmm-yy;@", "[$-409]mmmm-yy;@", "[$-409]mmmm d, yyyy;@", "[$-409]m/d/yy h:mm AM/PM;@", "m/d/yy h:mm;@", "[$-409]mmmmm;@", "[$-409]mmmmm-yy;@", "m/d/yyyy;@", "[$-409]d-mmm-yyyy;@"],
                    a.chinaDateFormat = ["yyyy-mm-dd;@", '[DBNum1][$-804]yyyy"\u5e74"m"\u6708"d"\u65e5";@', '[DBNum1][$-804]yyyy"\u5e74"m"\u6708";@', '[DBNum1][$-804]m"\u6708"d"\u65e5";@', "[$-409]yyyy/m/d h:mm AM/PM;@", 'yyyy"\u5e74"m"\u6708"d"\u65e5";@', 'yyyy"\u5e74"m"\u6708";@', 'm"\u6708"d"\u65e5";@', "mm/dd/yy;@", "m/d/yy;@", "yyyy/m/d h:mm AM/PM;@", "yyyy/m/d h:mm;@", "[$-409]d-mmm;@", "[$-409]d-mmm-yy;@", "[$-409]dd-mmm-yy;@", "[$-409]mmm-yy;@", "[$-409]m", "[$-409]m-d;@"],
                    a.koreanDateFormat = ["yyyy-mm-dd;@", 'yyyy"\ub144" m"\uc6d4" d"\uc77c";@', 'yy"\u5e74" m"\u6708" d"\u65e5";@', 'yyyy"\ub144" m"\uc6d4";@', 'm"\uc6d4" d"\uc77c";@', "yy-m-d;@", "yy-m-d h:mm;@", 'm"\u6708"d"\u65e5";@', "[$-412]yy-m-d AM/PM h:mm;@", "yy/m/d;@", "yyyy/m/d h:mm;@", "m/d;@", "m/d/yy;@", "mm/dd/yy;@", "[$-409]d-mmm;@", "[$-409]d-mmm-yy;@", "[$-409]dd-mmm-yy;@", "[$-409]mmm-yy;@", "[$-409]m", "[$-409]m-d;@"],
                    a.japanWesternDateFormat = ['yyyy"\u5e74"m"\u6708"d"\u65e5";@', 'yyyy"\u5e74"m"\u6708";@', 'm"\u6708"d"\u65e5";@', "yyyy/m/d;@", "[$-409]yyyy/m/d h:mm AM/PM;@", "yyyy/m/d h:mm;@", "m/d;@", "m/d/yy;@", "mm/dd/yy;@", "[$-409]d-mmm;@", "[$-409]d-mmm-yy;@", "[$-409]dd-mmm-yy;@", "[$-409]mmm-yy;@", "[$-409]mmmm-yy;@", "[$-409]mmmmm;@", "[$-409]mmmmm-yy;@"],
                    a.japanEmperorReignDateFormat = ["[$-411]ge.m.d;@", '[$-411]ggge"\u5e74"m"\u6708"d"\u65e5";@'],
                    a.japanEmperorReignFirstYearDateFormat = ["[$-411]ge.m.d;@", '[$-ja-JP-x-gannen]ggge"\u5e74"m"\u6708"d"\u65e5";@'],
                    a.timeFormats = ["[$-409]h:mm:ss AM/PM", "h:mm;@", "[$-409]h:mm AM/PM;@", "h:mm:ss;@", "[$-409]h:mm:ss AM/PM;@", "mm:ss.0;@", "[h]:mm:ss;@", "[$-409]m/d/yy h:mm AM/PM;@", "m/d/yy h:mm;@"],
                    a.chinaTimeFormats = ["h:mm;@", "[$-409]h:mm AM/PM;@", "h:mm:ss;@", 'h"\u65f6"mm"\u5206";@', 'h"\u65f6"mm"\u5206"ss"\u79d2";@', '[$-804]AM/PM h"\u65f6"mm"\u5206";;@', '[$-804]AM/PM h"\u65f6"mm"\u5206"ss"\u79d2";@', '[DBNum1][$-804]h"\u65f6"mm"\u5206";@', '[DBNum1][$-804]AM/PM h"\u65f6"mm"\u5206";@'],
                    a.koreanTimeFormats = ["h:mm;@", "h:mm:ss;@", "[$-412]AM/PM h:mm;@", "[$-412]AM/PM h:mm:ss;@", "[$-409]h:mm AM/PM;@", "[$-409]h:mm:ss AM/PM;@", 'yyyy"-"m"-"d h:mm;@', '[$-412]yyyy"-"m"-"d AM/PM h:mm;@', '[$-409]yyyy"-"m"-"d h:mm AM/PM;@', 'h"\uc2dc" mm"\ubd84";@', 'h"\uc2dc" mm"\ubd84" ss"\ucd08";@', '[$-412]AM/PM h"\uc2dc" mm"\ubd84";@', '[$-412]AM/PM h"\uc2dc" mm"\ubd84" ss"\ucd08";@'],
                    a.japanTimeFormats = ["h:mm;@", "[$-409]h:mm AM/PM;@", "h:mm:ss;@", "[$-409]h:mm:ss AM/PM;@", "[$-409]yyyy/m/d h:mm AM/PM;@", "yyyy/m/d h:mm;@", 'h"\u6642"mm"\u5206";@', 'h"\u6642"mm"\u5206"ss"\u79d2";@'],
                    a.textFormats = ["@"],
                    a.specialFormats = ["00000", "00000-0000", "[<=9999999]###-####;(###) ###-####", "000-00-0000"],
                    a.specialJapanFormats = ["[<=999]000;[<=9999]000-00;000-0000", "[<=99999999]####-####;(00) ####-####", "'\u25b3' #,##0;'\u25b2' #,##0", "[DBNum1][$-411]General", "[DBNum2][$-411]General", "[DBNum3][$-411]0", "[DBNum3][$-411]#,##0"],
                    a.specialKoreanFormats = ["000-000", "[<=999999]####-####;(0##) ####-####", "[<=9999999]###-####;(0##) ###-####", "000000-0000000", "[DBNum1][$-412]General", "[DBNum2][$-412]General", "[$-412]General"],
                    a.specialChinaFormats = ["000000", "[DBNum1][$-804]General", "[DBNum2][$-804]General"],
                    a.currencyFormats = ["#,##0", "#,##0;[Red]#,##0", "#,##0;-#,##0", "#,##0;[Red]-#,##0"],
                    a.percentageFormats = ["0%"],
                    a.scientificFormats = ["0E+00"],
                    a.accountingFormats = ['_(* #,##0_);_(* (#,##0);_(* "-"?_);_(@_)', '_($* #,##0_);_($* (#,##0);_($* "-"?_);_(@_)', '_ [$\xa5-804]* #,##0_ ;_ [$\xa5-804]* \\-#,##0_ ;_ [$\xa5-804]* "-"?_ ;_ @_ ', '_-[$\xa5-411]* #,##0_-;\\-[$\xa5-411]* #,##0_-;_-[$\xa5-411]* "-"?_-;_-@_-', '_-[$\u20a9-412]* #,##0_-;\\-[$\u20a9-412]* #,##0_-;_-[$\u20a9-412]* "-"?_-;_-@_-'],
                    a.customFormats = ["General", "0", "0.00", "#,##0", "#,##0.00", "#,##0;(#,##0)", "#,##0;[Red](#,##0)", "#,##0.00;(#,##0.00)", "#,##0.00;[Red](#,##0.00)", "$#,##0;($#,##0)", "$#,##0;[Red]($#,##0)", "$#,##0.00;($#,##0.00)", "$#,##0.00;[Red]($#,##0.00)", "0%", "0.00%", "0.00E+00", "##0.0E+0", "# ?/?", "# ??/??", "m/d/yyyy", "d-mmm-yy", "d-mmm", "mmm-yy", "h:mm AM/PM", "h:mm:ss AM/PM", "hh:mm", "hh:mm:ss", "m/d/yyyy hh:mm", "mm:ss", "mm:ss.0", "@", "[h]:mm:ss", '$ #,##0;$ (#,##0);$ "-";@', ' #,##0; (#,##0); "-";@', '$ #,##0.00;$ (#,##0.00);$ "-"??;@', ' #,##0.00; (#,##0.00); "-"??;@', "hh:mm:ss", "00000", "# ???/???", "000-00-0000", "dddd, mmmm dd, yyyy", "m/d;@", "[<=9999999]###-####;(###) ###-####", "# ?/8"],
                    a.accountingSymbol = [["None", null, null], ["$", "$", "en-US"], ["\xa5(Chinese)", "\xa5", "zh-cn"], ["\xa5(Japanese)", "\xa5", "ja-jp"], ["\u20a9(Korean)", "\u20a9", "ko-kr"]],
                    a.specialType = ["Zip Code", "Zip Code + 4", "Phone Number", "Social Security Number"],
                    a.specialJapanType = ["\u90f5\u4fbf\u756a\u53f7", "\u96fb\u8a71\u756a\u53f7\uff08\u6771\u4eac)", "\u6b63\u8ca0\u8a18\u53f7 \uff08+ = \u25b3; - = \u25b2)", "\u6f22\u6570\u5b57\uff08\u5341\u4e8c\u4e07\u4e09\u5343\u56db\u767e\uff09", "\u5927\u5b57 (\u58f1\u62fe\u5f10\u842c\u53c2\u9621\u56db\u767e)", "\u5168\u89d2 (\uff11\uff12\uff13\uff14\uff15)", "\u5168\u89d2 \u6841\u533a\u5207\u308a\uff08\uff11\uff12,\uff13\uff14\uff15\uff09"],
                    a.specialKoreanType = ["\uc6b0\ud3b8 \ubc88\ud638", "\uc804\ud654 \ubc88\ud638 (\uad6d\ubc88 4\uc790\ub9ac)", "\uc804\ud654 \ubc88\ud638 (\uad6d\ubc88 3\uc790\ub9ac)", "\uc8fc\ubbfc\ub4f1\ub85d\ubc88\ud638", "\uc22b\uc790(\ud55c\uc790)", "\uc22b\uc790(\ud55c\uc790-\uac16\uc740\uc790)", "\uc22b\uc790(\ud55c\uae00)"],
                    a.specialChinaType = ["\u90ae\u653f\u7f16\u7801", "\u4e2d\u6587\u5c0f\u5199\u5b57\u6bcd", "\u4e2d\u6587\u5927\u5199\u5b57\u6bcd"],
                    a.fractionType = ["Up to one digit (1/4)", "Up to two digits (21/25)", "Up to three digits (312/943)", "As halves (1/2)", "As quarters (2/4)", "As eighths (4/8)", "As sixteenths (8/16)", "As tenths (3/10)", "As hundredths (30/100)"],
                    a.negativeNumbers = {
                        "-1234.10": "-1234.10",
                        "red:1234.10": "1234.10",
                        "(1234.10)": "(1234.10)",
                    ...
                    a.insertPictureDialogTitle = "Insert Picture",
                    a.pictureFormatFilter = {
                    ...
                    a.InsertFunctionsChildrenDialog = {
