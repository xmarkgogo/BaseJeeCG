(function () {
    ...
    var TextRuleFormatDialog = (function (_super) {
        ...
        TextRuleFormatDialog.prototype._initOptions = function () {
            var self = this;
            return {
                title: designer.res.conditionalFormatting.textThatContains.title,
                width: 'auto',
                resizable: false,
                modal: true,
                buttons: [{
    ...
    var chartErrorBar = (function (_super) {
        ...
        chartErrorBar.prototype._applySetting = function () {
            ...
            this._seriesCollection.set(this._index, this._serise);
                ...
                MessageBox.show(designer.res.conditionalFormatting.exceptions.e7, designer.res.title, 2 /* warning */);
                return;
            }
            this.close();
        }
    ...
    var chartTrendlineDialog = (function (_super) {
        ...
        chartTrendlineDialog.prototype._applySetting = function (index) {
            ...
            if (serie) {
                ...
                if (trendline) {
                    trendline.style = {color: serie.backColor};
                    if (!serie.trendlines) {
                        serie.trendlines = [];
                    }
                    serie.trendlines.push(trendline);
                }
    ...
    var chartHiddenEmptyCellDialog = (function (_super) {
        ...
        function chartHiddenEmptyCellDialog(hiddenAndEmptyCellsOptionCallBack) {
            this.hiddenAndEmptyCellsOptionCallBack = hiddenAndEmptyCellsOptionCallBack;
            ...
            return {
                ...
                buttons: [{
                    ...
                    click: function () {
                        ...
                        var showHiddenRowsAndColumns = $("#show-data-in-hidden-rowColumn").prop("checked");
                        var displayNaNAsBlank = $("#show-nan-as-empty").prop("checked");
                        self._applySetting(value === "connectData" ? 0 : (value === "gaps" ? 1 : 2), displayNaNAsBlank, showHiddenRowsAndColumns);
                    }
                },
                {
                    text: designer.res.close,
        ...
        chartHiddenEmptyCellDialog.prototype._applySetting = function (index, displayNaNAsBlank, showHiddenRowsAndColumnsVal) {
            this.hiddenAndEmptyCellsOptionCallBack(index, displayNaNAsBlank, showHiddenRowsAndColumnsVal);
            this.close();
        }
        ...
        chartHiddenEmptyCellDialog.prototype._beforeOpen = function () {
            ...
            var ignorHiddenRowsAndColumns = this._acChart.ignoreHidden();
            var displayNaNAsBlank = this._acChart.displayNaNAsBlank();
            if (index === 0) {
            ...
            if (chartType === "ColumnGroup" || chartType === "AreaGroup" || chartType === "BarGroup" || chartType === "PieGroup") {
                $('#connectData').attr("disabled", true);
            } else {
                $('#connectData').attr("disabled", false);
            }
            $('#show-nan-as-empty').prop('checked', displayNaNAsBlank);
            $('#show-data-in-hidden-rowColumn').prop('checked', !ignorHiddenRowsAndColumns);
        }
